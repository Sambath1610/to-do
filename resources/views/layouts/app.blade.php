...
<head>
  ...
  <style type="text/tailwindcss">
      .btn {
        @apply rounded-md px-2 py-1 font-medium text-center shadow-sm ring-1 ring-slate-700/10 hover:bg-slate-50;
      }

      .link{
        @apply underline text-gray-900 font-medium decoration-green-500
      }
